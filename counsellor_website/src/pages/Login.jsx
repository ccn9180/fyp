    ...
    <div style={s.wrap}>
      ...
      <div id="login-card" style={s.card}>
        ...
        <div style={s.leftPanel}>
          ...
          <div style={s.logoSub}>Professional Counsellor Portal</div>
        </div>

        {/* Right Panel - Login Form */}
        <div style={s.rightPanel}>
          <div style={s.cardTitle}>Welcome back</div>
          <div style={s.cardSub}>Sign in to connect and support your clients.</div>
            ...
            <div>
              ...
              <div style={s.inputWrap}>
                ...
                <input
                  ...
                  type="email"
                  style={s.input}
                  placeholder="counsellor@eunoia.com"
                  value={email}
          ...
          <p style={s.footer}>Eunoia © {new Date().getFullYear()} · Professional Counsellor Portal</p>
        </div>
      </div>
