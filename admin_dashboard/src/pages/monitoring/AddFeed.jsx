...
import { 
  ...
  MessageSquare, ShieldCheck, Stars, Loader2,
    ...
    <div className="max-w-5xl mx-auto w-full flex flex-col gap-10 py-6 animate-in fade-in slide-in-from-bottom-8 duration-700 ease-out">
      ...
      <div className="flex items-end justify-between px-2">
        ...
        <button 
          ...
          className={`group px-10 py-4 rounded-3xl font-display font-bold text-sm transition-all flex items-center gap-3 relative overflow-hidden ${
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 sticky top-6">
           ...
           <div className="bg-white rounded-[2.5rem] p-8 border border-cream-darker shadow-lg">
              ...
              <div className="grid grid-cols-1 gap-3">
                 {[
                   { id: 'General', label: 'General Pulse', icon: Stars },
                   { id: 'Self-Love', label: 'Self-Love Hub', icon: ShieldCheck },
                   { id: 'Anxiety', label: 'Anxiety Portal', icon: Stars },
                   { id: 'Hope', label: 'Hope Station', icon: Stars },
                 ].map(t => (
                   <button 
                     key={t.id}
                     onClick={() => setTopic(t.id)}
                     className={`w-full p-4 rounded-2xl transition-all flex items-center justify-between group relative overflow-hidden ${
                       topic === t.id 
